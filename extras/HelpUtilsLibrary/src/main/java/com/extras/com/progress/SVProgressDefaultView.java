package com.extras.com.progress;
...
public class SVProgressDefaultView extends LinearLayout {
    ...
    /**
     * MaterialishProgress显示
     */
    public void setMaterialishProgress(){
    ...
    public void showMaterialishProgress(String string){
        if (string == null) {
            showMaterialProgress();
            return;
        }
        showBaseStatusMaterialish(string);
    }
    ...
    public void showBaseStatusMaterialish(String string) {
        clearAnimations();
        tvMsg.setText(string);
        ivBigLoading.setVisibility(View.GONE);
        circleProgressBar.setVisibility(View.GONE);
